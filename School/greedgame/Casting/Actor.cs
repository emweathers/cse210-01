...
namespace greedgame.Casting
{
    ...
    public class Actor
    {
        ...
        public int points; // Not location points, but the points of the player, and the points added from an interactable to the player
        ...
        /// <summary>Returns the X position of the actor</summary>
        /// <returns>Position X</returns>
        public int GetPositionX() {
            return position.GetX();
        }

        /// <summary>Returns the Y position of the actor</summary>
